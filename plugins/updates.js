...
smd(
  {
    pattern: "channel",
    type: "misc",
    info: "Akashi-MD Support Channels",
  },
  async (_0x5ce955) => {
    try {
      let _0x1a71d9 = "https://whatsapp.com/channel/0029VaoOYCpHgZWcZwhD6V21";
      let _0x162ed5 =
        "*_https://whatsapp.com/channel/0029VaoOYCpHgZWcZwhD6V21_*\n*_JOIN WHATSAPP CHANNEL TO GET UPDATES._*\n\n\n*_https://www.youtube.com/@SSK-FAMILYCAMPAGNY !_*\n*_WATCH HELPFULL VIDEO TUTORIALS ABOUT WHATSAPP BOTS FROM YOUTUBE ♥._*\n";
  ...
  async (_0x173fc2, _0x1e33bd) => {
    try {
      ...
      for (let _0x12e4c4 of _0x1fd73d.participants) {
        let _0x2f7779 = /242067274660|22898555306/g.test(_0x12e4c4.id)
          ? "Akashi Sasakk"
