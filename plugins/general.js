  ...
  async (_0x45da98) => {
    try {
      let { data: _0x44f98c } = await axios.get(
        "https://api.github.com/repos/AKASHI-SASAKI/Akashi-MD"
      );
      let _0x1c73f9 = (
        "\nAkashi Md A simple Mutil Device WhatsApp Bot Created and Managed by *" +
        Config.ownername +
        "*. 👑\n\n  *❲❒❳ Stars:* " +
        (_0x44f98c?.stargazers_count || "None (🥲)") +
        " stars\n  *❲❒❳ Forks:* " +
        (_0x44f98c?.forks_count || "1000+") +
        " forks\n  *❲❒❳ Developer:* Sasaki Akashi\n  *❲❒❳ Created:* " +
        (_0x44f98c?.created_at || "2024/09") +
        "\n  *❲❒❳ Repo:* _https://github.com/AKASHI-SASAKI/Akashi-MD_\n  *❲❒❳ Scan:* _" +
        scan +
        "_\n" +
        (Config.caption ? "\n\n" + Config.caption : "")
      ).trim();
    ...
    try {
      if (
        ...
        if (
          ...
          _0x2dfb59[0].includes("𝙰𝚔𝚊𝚜𝚑𝚒-𝙼𝙳 • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
          ...
          try {
            if (_0x2ecd2a) {
              ...
              if (_0x13a11c.toLowerCase().startsWith("reply")) {
                ...
                let _0x3f6b59 =
                  "*𝙰𝚔𝚊𝚜𝚑𝚒-𝙼𝙳  • ʏᴏᴜʀ ᴀɴᴏɴʏ-ᴍsɢ ʀᴇᴘʟʏ*\n\n*_From @" +
